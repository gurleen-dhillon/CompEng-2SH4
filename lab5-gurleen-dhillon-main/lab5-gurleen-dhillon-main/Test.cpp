...
void testcase_Set_Copy_Add_ToString() {
	int arr[] = {3, 6, 9, 24, 89};
	SLLSet list = SLLSet(arr,5); //set
	SLLSet copied = list.copy(); //copy
	//add
	copied.add(100);
	copied.add(2);
	copied.add(25);
	copied.add(6);
	//string
	string expected1 = "3, 6, 9, 24, 89";
	string expected2 = "2, 3, 6, 9, 24, 25, 89, 100";

	ASSERT_EQUAL(expected1,list.toString());
	ASSERT_EQUAL(expected2,copied.toString());
}


void testcase_isIn_getSize_Remove(){
	int arr[] = {3, 6, 9, 24, 89};
	SLLSet list = SLLSet(arr,5);
	//IsIn
	int in = 5;
	...
	list.remove(89);
	list.remove(5);
	string expected2 = "6, 24"; //string
	//size
	int expectedSize = 2;

	ASSERT_EQUAL(expected1,list.isIn(in));
	ASSERT_EQUAL(expected2,list.toString());
	ASSERT_EQUAL(expectedSize,list.getSize());
}


void testcase_setUnion() {
	int arr1[] = {3, 6, 9, 24, 89};
	int arr2[] = {5, 6, 12, 24, 500};
	SLLSet list1 =  SLLSet(arr1,5);
	SLLSet list2 =  SLLSet(arr2,5);
	SLLSet list3 = list1.setUnion(list2);
	string expected = "3, 5, 6, 9, 12, 24, 89, 500";
	ASSERT_EQUAL(expected,list3.toString());
}
...
void testcase_intersection() {
	...
	SLLSet list1 =  SLLSet(arr1,5);
	SLLSet list2 =  SLLSet(arr2,5);
	SLLSet list3 = list1.intersection(list2);
	string expected = "6, 24";
	ASSERT_EQUAL(expected,list3.toString());
}
...
void testcase_difference() {
	...
	SLLSet list1 =  SLLSet(arr1,5);
	SLLSet list2 =  SLLSet(arr2,5);
	SLLSet list3 = list1.difference(list2);
	string expected = "3, 9, 89";
	ASSERT_EQUAL(expected,list3.toString());
}


void testcase_setUnionMatrix() {
	int arr1[] = {3, 6, 9, 24, 89};
	int arr2[] = {5, 6, 12, 24, 500};
	int arr3[] = {0, 49};
	int arr4[] = {-69, 385, 420};
	SLLSet list1 =  SLLSet(arr1,5);
	SLLSet list2 =  SLLSet(arr2,5);
	SLLSet list3 =  SLLSet(arr3,2);
	SLLSet list4 =  SLLSet(arr4,3);
	SLLSet Array[] = {list1, list2, list3, list4};

	SLLSet list5 = SLLSet::setUnion(Array,5);
	string expected = "-69, 0, 3, 5, 6, 9, 12, 24, 49, 89, 385, 420, 500";
	ASSERT_EQUAL(expected,list5.toString());
}
...
bool runAllTests(int argc, char const *argv[]) {
    ...
    s.push_back(CUTE(testcase_Set_Copy_Add_ToString));
    s.push_back(CUTE(testcase_isIn_getSize_Remove));
    s.push_back(CUTE(testcase_setUnion));
    s.push_back(CUTE(testcase_intersection));
    s.push_back(CUTE(testcase_difference));
    s.push_back(CUTE(testcase_setUnionMatrix));
