...
//=================Question 2================================
    ...
    void TestQ2_gurleen_test_case_1(CuTest *tc) {
    ...
    void TestQ2_gurleen_test_case_2(CuTest *tc) {
    ...
    void TestQ2_gurleen_test_case_3(CuTest *tc) {
...
*/
    ...
    void TestQ3_zero_gurleen_test_case(CuTest *tc) {
...
//=================Question 4================================ 
    ...
    void TestQ4_zero_gurleen_test_case(CuTest *tc) {
...
//=================Question 6================================   
    ...
    void TestQ6_gurleen_test_case(CuTest *tc) {
        int input = 40000000;
        int expected[100]={0},actual[100]={0};
        expected[0]=6;
        expected[1]=28;
...
//=================Question 7================================  
    ...
    void TestQ7a_gurleen_test_case(CuTest *tc) {
        int input = 0012300;
        int actual = Q7a(input);
        int expected = 32100;
        CuAssertIntEquals(tc, expected, actual);
    ...
    void TestQ7b_gurleen_test_case(CuTest *tc) {
        int input = 001234500;
        int actual = Q7b(input);
        int expected = 5432100;
        CuAssertIntEquals(tc, expected, actual);
    }
    ...
    CuSuite* Lab1GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ2_gurleen_test_case_1);
        SUITE_ADD_TEST(suite, TestQ2_gurleen_test_case_2);
        SUITE_ADD_TEST(suite, TestQ2_gurleen_test_case_3);
        ...
        SUITE_ADD_TEST(suite, TestQ6_gurleen_test_case);
        

        SUITE_ADD_TEST(suite, TestQ7a_1);
        SUITE_ADD_TEST(suite, TestQ7a_2);
        SUITE_ADD_TEST(suite, TestQ7a_gurleen_test_case);
        SUITE_ADD_TEST(suite, TestQ7b_1);
        SUITE_ADD_TEST(suite, TestQ7b_2);
        SUITE_ADD_TEST(suite, TestQ7b_gurleen_test_case);
